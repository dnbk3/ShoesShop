...
public class SupplierService {
    ...
    public List<Supplier> GetAll(){
        ...
        String endPoint = "http://localhost:8082/core/supplier";
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                ...
                List<Supplier> list = objectMapper.readValue(jsonObject
                        .getJSONArray("data").toString(), new TypeReference<List<Supplier>>() {});
